        ...
        <div className="fixed top-0 z-50 w-full flex justify-between items-center bg-loti-200 text-white h-20 border-b-2 border-loti-300 px-2">
            <div className="flex flex-row justify-between max-w-5xl mx-auto w-full">
                <Link href="/" className="flex items-center">
                    <img src="https://cdn.discordapp.com/avatars/1278104086260088873/a_48ecde5f87ce6989219b6d6d7223be15.gif?size=1024" alt="scared" className="w-14 h-14 rounded-full" />
                    <h1 className="text-4xl font-bold ml-2">scared</h1>
                </Link>
                ...
                <Link href='https://discord.gg/please' className="flex items-center bg-blue-500 px-4 rounded-2xl gap-2 h-10 mt-2 hover:bg-blue-700 sm:mt-4">
                    <BsDiscord />
                    <span>Discord</span>
                </Link>
            </div>
