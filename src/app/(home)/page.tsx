    ...
    return (
        <>
            <div className="flex flex-col h-screen w-screen items-center justify-center mt-20 sm:mt-0">
                <img
                    src="https://cdn.discordapp.com/avatars/1278104086260088873/a_48ecde5f87ce6989219b6d6d7223be15.gif?size=1024"
                    className="w-52 h-52 rounded-xl"
                />
                <h1 className="text-6xl font-bold text-white">scared</h1>
