          ...
          <div className="h-full flex flex-col justify-between">
            <div className="px-6">
              ...
              <p className="text-sm mt-3 text-neutral-400 font-medium pr-4">
                ...
                <a href="https://discord.gg/please" className="text-blue-400">
                  our support server
                </a>{" "}
                and open a ticket.
                <br /> <br />
            ...
            <div>
              ...
              <div className="px-6 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      <i>
                        ...
                        “Our”, or “Company” refer to the Evict (Bot) or the
                        company providing these terms of service (Evict). The
                      ...
                      <br />
                      <br />
                      Thank you for choosing Evict (Bot). These Terms and
                      ...
                      <ol className="pl-3">
                        <li className="text-white list-disc list-inside">
                          <a
                            href="https://discord.gg/please"
                            className="text-blue-400"
                            target="_blank"
                          >
                            https://discord.gg/please
                          </a>
                        </li>
                      </ol>
                      <br />
                ...
                <div>
                  <p className="text-sm tracking-wide text-loti-pink font-medium">
                    What information does Evict (Bot) collect from you? as a
                    user:
                  </p>
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Evict (Bot) is a Discord Bot that requires information to
                      ...
                      <ol className="text-white list-disc list-inside pl-3">
                        ...
                        <li>
                          ...
                          being stored in Evict completely
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          that data from being stored in Evict completely
                        </li>
                        <li>
                          ...
                          Afk data is deleted from Evict&apos;s storage completely
                        </li>
                      </ol>
                      <br />
                      These are only a few instances of the information we
                      gather from you as a user; as Evict is a multifunctional
                ...
                <div>
                  <p className="text-sm tracking-wide text-loti-pink font-medium">
                    What information does Evict (Bot) collect from a guild?
                  </p>
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Evict (Bot) also requires information from the specific
                      ...
                      <ol className="text-white list-disc list-inside pl-3">
                        ...
                        <li>
                          ...
                          enabled, or deleted from Evict&apos;s storage completely
                        ...
                        <li>
                          ...
                          and can use Evict (bot) services.
                        </li>
                        <li>
                          ...
                          <ol className="text-white list-disc list-inside pl-6">
                            ...
                            <li>
                              ...
                              automatically deleted from Evict&apos;s storage (48
                      ...
                      <br />
                      These are only a few instances of the information we
                      gather from you as a guild; as Evict is a multifunctional
                      bot with more than 250 commands and growing, we are unable
                      to show you all the information we gather. Please contact
                      us{" "}
                      <a
                        href="https://discord.gg/please"
                ...
                <div>
                  <p className="text-sm tracking-wide text-loti-pink font-medium">
                    What other information does Evict (Bot) collect?
                  </p>
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Evict (Bot) collects various types of data, which may be
                      ...
                      <ul className="text-white list-disc list-inside pl-3">
                        <li>
                          <b>Blacklist from Evict:</b> if blacklisted from Evict
                          by bot admins, Evict stores the user id of the
                          blacklisted user as well as the reason provided by the
                          bot admins
                        </li>
                        <li>
                          <b>Paid sheet:</b> Evict has a sheet that includes the
                          paid members ids to keep track of payments
                        </li>
                        <li>
                          <b>Payment email:</b> Evict gets the email used when
                          paying for <b>Evict Paid</b> to send updates to
                          services as well as invoices
                        </li>
                        <li>
                          <b>Email address:</b> Evict gets the email address
                          used when paying for <b>Evict Paid</b> to send updates
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      <br />
                      <br />
                      Evict (Bot) uses the collected data to finish processes
                      and run commands such as starboard which requires the
                      starboard data to function properly.
                      <br />
                      <ol className="text-white list-disc list-inside pl-3">
                        <li>
                          <b>Complete a bots task:</b> some commands in Evict
                          rely on data that is stored, or set by Evict&apos;s users
                          and consumers, such as:
                          <ol className="text-white list-disc list-inside pl-6">
                            <li>
                              <b>Starboard:</b> Evict requires the starboard
                              data, such as channel id, emoji, and threshold for
                              the starboard command to properly work
                            </li>
                            <li>
                              <b>Autorole:</b> Evict requires the autorole data,
                        ...
                        <li>
                          <b>Feedback and errors:</b> Evict stores all the
                        ...
                        <li>
                          <b>Bot presence:</b> the presence of Evict includes
                          the number of guilds Evict is in
                        </li>
                      </ol>
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Evict does not share the information collected or
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      data from Evict, you can contact us at:
                      <ol className="pl-3">
                        <li className="text-white list-disc list-inside">
                          <a
                            href="https://discord.gg/please"
