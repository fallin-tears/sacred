          ...
          <div className="h-full flex flex-col justify-between">
            <div className="px-6">
              ...
              <p className="text-sm mt-3 text-neutral-400 font-medium pr-4">
                ...
                and open a ticket.
                <br /> <br />
                Date created: 15th of July 2024
                <br />
                Date revised: 15th of July 2024
              </p>
            </div>
            <div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      <br />
                      <br />
                      Evict (Bot) also reserves the right to pull any services
                    ...
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      <ol className="text-white list-disc list-inside pl-3">
                        <li>
                          ...
                          such as <b>Evict (Bot) API</b>
                        </li>
                        <li>
                          <b>Attempt to hack:</b> you may not attempt to hack{" "}
                          <b>Evict (Bot)</b> in any way
                        </li>
                        <li>
                          <b>Improper use:</b> you must use Evict (Bot) in a way
                        ...
                        <li>
                          ...
                          have the purpose of attacking <b>Evict (Bot)</b> and
                        ...
                        <li>
                          ...
                          of damaging our company, brand, and services (Evict Bot). This includes but is not
